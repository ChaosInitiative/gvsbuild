...
from .utils.utils import convert_to_msys, file_replace, python_find_libs_dir
...
class Project_openssl(Tarball, Project):
    def __init__(self):
        Project.__init__(
            self,
            "openssl",
            archive_url="https://www.openssl.org/source/openssl-1.1.1m.tar.gz",
...
class Project_sqlite(Tarball, Project):
    ...
    def build(self):
        ...
        self.exec_vs(
            r"nmake /f Makefile.msc sqlite3.dll DYNAMIC_SHELL=1 " + nmake_debug
        )
